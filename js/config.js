...
export const ENERGY = {
  ...
  eatingDuration: 40,        // ticks to eat a berry
  maturityAge: 800,          // ticks after growth before can mate
...
export const SETTINGS_META = {
  ...
  energy: {
    ...
    params: [
      ...
      { key: "maxHealth",              label: "Max Health",         min: 50,    max: 500,  step: 10,  obj: ENERGY,
        tip: "Maximum health. Drains when out of food or water. Reduced by predator attacks." },
      ...
      { key: "eatingDuration",         label: "Eating Duration",    min: 10,    max: 120,  step: 5,   obj: ENERGY,
        tip: "Ticks it takes to eat a berry." },
      { key: "maturityAge",            label: "Maturity Age",       min: 100,   max: 2000, step: 50,  obj: ENERGY,
