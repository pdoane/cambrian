...
const GENE_TIPS = {
  ...
  size:         "Body radius. Bigger = more health and wider eating range, but higher movement and idle cost.",
  eyesight:     "Detection range for food, water, and mates. Increases idle metabolism.",
  attack:       "Damage per tick when attacking prey. > 0.3 makes this a predator.",
  defense:      "Reduces incoming attack damage. Increases idle metabolism.",
  efficiency:   "Energy extracted per meal (0\u20131). Increases idle metabolism.",
  ...
  charisma:     "Mating success chance. Both partners' values multiply. Higher = more visible to predators.",
